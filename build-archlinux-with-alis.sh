...
echo
	...
	git clone https://github.com/amanre/alis $buildFolder/archiso/airootfs/alis
	mkdir $buildFolder/archiso/airootfs/alis-dev
	git clone https://github.com/amanre/alis-dev $buildFolder/archiso/airootfs/alis-dev
